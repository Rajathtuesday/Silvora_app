...
// import '../../services/removal/vault_service.dart';
...
// }
// ================================================================================
//lib/screens/login/login_screen.dart ==> minimal login screen 
import 'dart:convert';
import 'package:flutter/material.dart';
import 'package:http/http.dart' as http;
...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Future<void> _login() async {
    ...
    try {
      ...
      await SecureState.unlockVault(passCtrl.text);

      if (!mounted) return;
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(
          builder: (_) => const VaultUnlockedScreen(),
        ),
      );
    } catch (e) {
        ...
        child: Column(
          children: [
            ...
            ElevatedButton(
              ...
              child: loading ? const CircularProgressIndicator() : const Text("Unlock"),
            )
          ],
        ),
      ),
